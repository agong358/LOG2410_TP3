...
void TeamViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TeamViewer *_t = static_cast<TeamViewer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject TeamViewer::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_TeamViewer.data,
      qt_meta_data_TeamViewer,  qt_static_metacall, nullptr, nullptr}
};
...
void *TeamViewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TeamViewer.stringdata0))
        return static_cast<void*>(const_cast< TeamViewer*>(this));
