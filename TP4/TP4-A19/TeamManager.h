...
public:
	...
	//virtual TeamMember& addMemberToTeam(std::string name, const class QImage& photo);
	...
	//virtual TeamComponentIterator currentTeam();
	//virtual TeamComponentIterator_const currentTeam() const;
	virtual void deleteTeam(TeamComponentIterator_const child);
	virtual void deleteAllTeams(void);

private:
	TeamComponentContainer m_teams;
	//TeamComponentIterator m_currentTeam;
};
